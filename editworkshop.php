            ...
            <div class="container">
                ...
                <form class="form-horizontal" action="editworkshop.php?workshop_id=<?php echo $workshop_id ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                            echo selectBox("workshopleader", "workshopleider w INNER JOIN beschikbaarheid b ON w.workshopleider_id = b.workshopleider_id", array("achternaam", "voornaam", "workshopleider_id"), "workshopleider_id", array("achternaam", "voornaam"), "achternaam, voornaam", NULL, "AANTAL_UUR - (CAST(DATEDIFF(minute, starttijd , eindtijd) AS NUMERIC(5,2)) / 60.00) >= 0");
                            ?>
                            <script>

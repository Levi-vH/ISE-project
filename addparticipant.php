        ...
        <div class="col-md-10 col-sm-8 main-content">
            ...
            <div>
                <form class="form-group" action="addparticipant.php?id=<?php echo $id?>" method="post">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2 font-weight-bold" for="dateofbirth">Geboortedatum:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2 font-weight-bold" for="organisation">Organisatie:</label>
                        <div class="col-sm-4">

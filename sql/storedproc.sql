...
BEGIN
	...
	SET @sql =	N'
				SELECT	W.WORKSHOP_ID,
						...
						(SELECT COUNT(*) FROM DEELNEMER_IN_WORKSHOP WHERE WORKSHOP_ID = W.WORKSHOP_ID) AS AANTAL_DEELNEMER_AANVRAAG,
	...
	IF(@orderdirection IS NULL)
		...
		END
	--SETS HIER
	--EXEC @sql, N'variabelen', variabelen

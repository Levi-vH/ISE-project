...
BEGIN
	...
	INSERT INTO DEELNEMER ([SECTORNAAM], [ORGANISATIENUMMER], [AANHEF], [VOORNAAM], [ACHTERNAAM],
	...
	VALUES(NULL, NULL, NULL, NULL, NULL, NULL, 'henkpieter.nl', NULL, NULL, NULL, NULL, NULL, NULL);  
END
GO
...
BEGIN
	...
	INSERT INTO DEELNEMER ([SECTORNAAM], [ORGANISATIENUMMER], [AANHEF], [VOORNAAM], [ACHTERNAAM],
						   [GEBOORTEDATUM], [EMAIL], [TELEFOONNUMMER], [OPLEIDINGSNIVEAU], [ORGANISATIE_VESTIGINGSPLAATS],
						   [IS_OPEN_INSCHRIJVING], [GEWENST_BEGELEIDINGSNIVEAU], [FUNCTIENAAM])
	VALUES(NULL, NULL, NULL, NULL, NULL, NULL, 'henk@pieternl', NULL, NULL, NULL, NULL, NULL, NULL); 
END
GO
...
BEGIN
	...
	INSERT INTO DEELNEMER ([SECTORNAAM], [ORGANISATIENUMMER], [AANHEF], [VOORNAAM], [ACHTERNAAM],
						   [GEBOORTEDATUM], [EMAIL], [TELEFOONNUMMER], [OPLEIDINGSNIVEAU], [ORGANISATIE_VESTIGINGSPLAATS],
						   [IS_OPEN_INSCHRIJVING], [GEWENST_BEGELEIDINGSNIVEAU], [FUNCTIENAAM])
	VALUES(NULL, NULL, NULL, NULL, NULL, NULL, 'henk@pieter.nl', NULL, NULL, NULL, NULL, NULL, NULL); 
END
GO
...
BEGIN
	...
	INSERT INTO DEELNEMER ([SECTORNAAM], [ORGANISATIENUMMER], [AANHEF], [VOORNAAM], [ACHTERNAAM],
						   [GEBOORTEDATUM], [EMAIL], [TELEFOONNUMMER], [OPLEIDINGSNIVEAU], [ORGANISATIE_VESTIGINGSPLAATS],
						   [IS_OPEN_INSCHRIJVING], [GEWENST_BEGELEIDINGSNIVEAU], [FUNCTIENAAM])
	VALUES(NULL, NULL, NULL, NULL, NULL, DATEADD(s, 20, GETDATE()), NULL, NULL, NULL, NULL, NULL, NULL, NULL); 
END
GO

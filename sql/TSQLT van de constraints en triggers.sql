...
BEGIN
	...
	INSERT INTO	testBeschikbaarheid (WORKSHOPLEIDER_ID, JAAR, KWARTAAL, AANTAL_UUR)
	VALUES		(1, 2019, 4, 13)

	EXEC tSQLt.FakeTable @Tablename = 'dbo.BESCHIKBAARHEID'; 
	EXEC tSQLt.FakeTable @Tablename = 'dbo.MODULE_VAN_GROEP'; 

	INSERT INTO	BESCHIKBAARHEID (WORKSHOPLEIDER_ID, JAAR, KWARTAAL, AANTAL_UUR)
	VALUES		(1, 2019, 4, 9)

	INSERT INTO	MODULE_VAN_GROEP (WORKSHOPLEIDER, STARTTIJD, EINDTIJD, DATUM)
	VALUES		(1, '13:00:00.00000', '17:00:00.00000', '2019-10-10') 
	...
	SET WORKSHOPLEIDER = 2
	WHERE WORKSHOPLEIDER = 1

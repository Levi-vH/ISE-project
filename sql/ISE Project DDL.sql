...
CREATE TYPE Aantal_Uur FROM NUMERIC(5,2)
...
ALTER TABLE WORKSHOP
	ADD CONSTRAINT FK_WORKSHOP_ref_PLANNER FOREIGN KEY (PLANNERNAAM)
...
ALTER TABLE AANVRAAG
	ADD CONSTRAINT FK_AANVRAAG_ref_SECTOR FOREIGN KEY (SECTORNAAM) 
		REFERENCES SECTOR(SECTORNAAM)
		ON UPDATE CASCADE
		ON DELETE NO ACTION
GO

        ...
        <form class="form-horizontal" action="" method="post">
            <div class="form-group">
                <label class="control-label col-sm-2" for="Organisation_Name">Naam Organisatie:</label>
                    <div class="col-sm-10">
                        <input id="Organisation_Name" type="text" class="form-control" value="<?= getOrganisationName($_SESSION['organisation']) ?>"
                               name="Organisation_Name" readonly>
                    </div>
            </div>
            <div class="form-group">
...
<script>
    ...
    function get_organisatie() {
        ...
        var organisatieValue = organisatienaam.value;
        $.ajax({
